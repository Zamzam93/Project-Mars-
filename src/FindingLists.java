...
public class FindingLists {
    ...
    public FindingsLists() throws InterruptedException {
        Thread.sleep(500);
        System.out.println("Welcome back from you expedition. Time to catalog everything you found,");
        ...
        System.out.println("Which of the fossil would you like to learn more about (Spelling Spacing is important)?");
